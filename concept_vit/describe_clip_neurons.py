...
if __name__ == '__main__':
    ...
    CLIP_og_utils.save_activations(clip_name=args.clip_model, target_name=args.target_model,
    ...
    for target_layer in args.target_layers:
        save_names = CLIP_og_utils.get_save_names(clip_name=args.clip_model, target_name=args.target_model,
                                          target_layer=target_layer, d_probe=args.d_probe,
                                          concept_set=args.concept_set, pool_mode=args.pool_mode,
                                          save_dir=args.activation_dir)
        target_save_name, clip_save_name, text_save_name = save_names

        similarities, target_feats = CLIP_og_utils.get_similarity_from_activations(
