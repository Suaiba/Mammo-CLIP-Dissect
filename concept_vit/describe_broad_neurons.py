...
# Initialize wandb
wandb.init(project="broader_clip-dissect", name="den_finetuned_mammoclip_broader_describe_neurons", config={})
...
parser.add_argument("--d_probe", type=str, default="vindr",
                    choices=["imagenet_broden", "cifar100_val", "imagenet_val", "broden", "imagenet_broden", "vindr", "imagenet_subsets",
                             "csaw", "csaw_all_splits","embed_png", "combined","embed_marker_84","embed_marker_only"],)
...
parser.add_argument("--top_k", type=int, default=100, help="Number of top activating images to use for similarity calculation")
...
if __name__ == '__main__':
    ...
    for target_layer in args.target_layers:
        ...
        target_save_name = f"{args.activation_dir}/latest_{args.d_probe}_mammo_pretrained_{target_save_name}"
        clip_save_name = f"{args.activation_dir}/latest_{args.d_probe}_mammo_pretrained_{clip_save_name}"
        text_save_name = f"{args.activation_dir}/latest_{args.d_probe}_mammo_pretrained_{text_save_name}"
        ...
        similarities, target_feats = utils.get_similarity_from_activations(
            ...
            device=args.device, d_probe=args.d_probe,top_k=args.top_k)
    ...
    if args.Breast_clip_chkpt is not None:
        if args.finetuned_img_classifier_chkpt is not None:
            save_csv_text = "NEW_vindr_cancer_finetuned_breast_clip_classifier_descriptions.csv"
            save_txt = "NEW_vindr_cancer_finetuned_breast_clip_classifier_descriptions_args.txt"
        else:
            if args.d_probe == "vindr":
                save_csv_text = "NEW_vindr_mammo_pretrained_breast_clip_classifier_descriptions.csv"
                save_txt = "NEW_vindr_mammo_pretrained_breast_clip_classifier_descriptions_args.txt"
            elif args.d_probe == "imagenet_subsets":
                save_csv_text = "imagenet_subsets_spec_small_mammo_pretrained_breast_clip_classifier_descriptions.csv"
                save_txt = "imagenet_subsets_spec_small_mammo_pretrained_breast_clip_classifier_descriptions_args.txt"
            elif args.d_probe == "combined":
                save_csv_text = "combined_mammo_pretrained_breast_clip_classifier_descriptions.csv"
                save_txt = "combined_mammo_pretrained_breast_clip_classifier_descriptions_args.txt"
            elif args.d_probe == "embed_png":
                save_csv_text = "embed_png_mammo_pretrained_breast_clip_classifier_descriptions.csv"
                save_txt = "embed_png_mammo_pretrained_breast_clip_classifier_descriptions_args.txt"
            elif args.d_probe == "embed_marker_84":
                save_csv_text = "embed_marker_84_mammo_pretrained_breast_clip_classifier_descriptions.csv"
                save_txt = "embed_marker_84_mammo_pretrained_breast_clip_classifier_descriptions_args.txt"
            elif args.d_probe == "embed_marker_only":
                save_csv_text = "embed_marker_only_mammo_pretrained_breast_clip_classifier_descriptions.csv"
                save_txt = "embed_marker_only_mammo_pretrained_breast_clip_classifier_descriptions_args.txt"
    else:
        if args.d_probe == "vindr":
            save_csv_text = "NEW_vindr_not_mammo_pretrained_breast_clip_descriptions.csv"
            save_txt = "NEW_vindr_not_mammo_pretrained_breast_clip_descriptions_args.txt"
        elif args.d_probe == "imagenet_subsets":
            save_csv_text = "imagenet_subsets_spec_small_not_mammo_pretrained_breast_clip_descriptions.csv"
            save_txt = "imagenet_subsets_not_spec_small_mammo_pretrained_breast_clip_descriptions_args.txt"
        elif args.d_probe == "combined":
            save_csv_text = "combined_not_mammo_pretrained_breast_clip_descriptions.csv"
            save_txt = "combined_not_mammo_pretrained_breast_clip_descriptions_args.txt"
        elif args.d_probe == "embed_png":
            save_csv_text = "embed_png_not_mammo_pretrained_breast_clip_descriptions.csv"
            save_txt = "embed_png_not_mammo_pretrained_breast_clip_descriptions_args.txt"
        elif args.d_probe == "embed_marker_84":
            save_csv_text = "embed_marker_84_not_mammo_pretrained_breast_clip_descriptions.csv"
            save_txt = "embed_marker_84_not_mammo_pretrained_breast_clip_descriptions_args.txt"
        elif args.d_probe == "embed_marker_only":
            save_csv_text = "embed_marker_only_not_mammo_pretrained_breast_clip_descriptions.csv"
            save_txt = "embed_marker_only_not_mammo_pretrained_breast_clip_descriptions_args.txt"
